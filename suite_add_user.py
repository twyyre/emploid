...
#GIVEN username starting with a number
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN existing username missing last character
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN existing username missing first character
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN username consisting of only underscores
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN username consisting of only numbers
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN username consisting of uppercase and lower case
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN username consisting of uppercase only
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN email starts with a number
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN mobile number containing letters
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN mobile number has more than 9 numbers
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN mobile number has less than 9 numbers
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN space in middle of password
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
...
#GIVEN user type is branch user 
beholder = taskman.start_task("record.py")
chrome = emp.chrome_run(_url="http://10.10.20.44:4455/", _maximized=False)
action_login(emp, _username="shewa", _password="11111111")
action_add_user(
